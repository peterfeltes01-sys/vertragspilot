...
export function getWarningLevel(contract) {
  if (contract.berechneterStatus === "gekuendigt" || contract.berechneterStatus === "ausgelaufen") return "none";
  const days = contract.tagesBisKuendigungsfrist ?? getDaysUntil(contract.naechsteKuendigung);
